...
gateway = braintree.BraintreeGateway(
    braintree.Configuration(
        ...
        merchant_id="26c42ypyxs2v7ymf",
        public_key="fddzws8hfq7t53ry",
        private_key="5dec04796ec0f538a6ca5923ce695e47"
    )
)
...
def generate_token(request, id, token):
    if not validate_user_session(id, token):
        return JsonResponse({'Error': 'Invalide session , please login again'})
